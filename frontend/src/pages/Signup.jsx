...
const Signup = () => {
  ...
  const { signup, isLoading, socialLogin } = useAuth();
      ...
      <div className={styles.authContainer}>
        <div className={styles.authCard}>
          <div className={styles.authHeader}>
            ...
            <p className={styles.authSubtitle}>Join thousands finding their next opportunity</p>
          </div>
          ...
          <form className={styles.authForm} onSubmit={handleSubmit}>
            ...
            <div className={styles.roleSelector}>
              ...
              <div className={styles.roleOptions}>
                <div
                  className={`${styles.roleOption} ${role === 'job_seeker' ? styles.selected : ''}`}
                  onClick={() => setRole('job_seeker')}
                >
                  <span className={styles.roleIcon}>👤</span>
                  <span className={styles.roleName}>Find a job</span>
                  <span className={styles.roleDescription}>Browse and apply</span>
                </div>
                <div
                  className={`${styles.roleOption} ${role === 'employer' ? styles.selected : ''}`}
                  onClick={() => setRole('employer')}
                >
                  <span className={styles.roleIcon}>🏢</span>
                  <span className={styles.roleName}>Hire talent</span>
                  <span className={styles.roleDescription}>Post jobs</span>
                </div>
              </div>
            </div>
